...
import GetInfoFromAadhar from "components/AadharApi";
...
function BloodIntake() {
  ...
  const validate = () => {
    let valid = true;
    let errors = { bloodId: "", batchNo: "", adharNo: "", bloodGroup: "" };

    if (!data.bloodId) {
      errors.bloodId = "Blood ID is required.";
      valid = false;
    }
    if (!data.batchNo) {
    ...
    if (!data.adharNo) {
      ...
      valid = false;
    } else   if(GetInfoFromAadhar(data.adharNo)===undefined) {errors.adharNo = "Aadhar Number must be in our DAtA.";
      valid = false;
    }
  
    
    
    if (data.bloodGroup === "select" || data.bloodGroup === "" ) {
  ...
  const formSubmit = async (e) => {
    e.preventDefault();
    const newd = data.adharNo in GetInfoFromAadhar;
    ...
    <>
      ...
      <div className="main">
        <div
          ...
          style={{
            backgroundImage: "url(" + require("assets/img/bg4.jpeg").default + ")",
                ...
                <Form action="" className="form" method="">
                  ...
                  <CardBody>
                    ...
                    <Row>
                        ...
                        {errors.bloodId && (
                          <div  style={{ color: "red", fontSize: "9px"  }}>{errors.bloodId}</div>
                        )}
                        <InputGroup
                          className={"input-lg" + (bloodIdFocus ? " input-group-focus" : "")}
                        >
                        ...
                        {errors.batchNo && (
                          <div style={{ color: "red", fontSize: "9px"  }}>{errors.batchNo}</div>
                        )}
                        <InputGroup
                          className={"input-lg" + (batchNoFocus ? " input-group-focus" : "")}
                        >
                          <InputGroupAddon addonType="prepend">
                            <InputGroupText>
                        ...
                        {errors.adharNo && (
                          <div style={{ color: "red", fontSize: "9px"  }}>{errors.adharNo}</div>
                        )}
                        <InputGroup
                          className={"input-lg" + (adharFocus ? " input-group-focus" : "")}
                        >
                          <InputGroupAddon addonType="prepend">
                            <InputGroupText>
                        ...
                        {errors.bloodGroup && (
                          <div style={{ color: "red", fontSize: "9px"  }}>{errors.bloodGroup}</div>
                        )}
                        <div
                          className="p-2"
                          style={{
