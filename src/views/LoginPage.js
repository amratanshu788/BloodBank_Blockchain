    ...
    let d = [
      {
        ...
        id: "0x3abA6Aab93369A5e427Cfe5F83de0cC21fE18C56",
        email: "bb1@gmail.com",
        pass: "1234",
        type: "1", // Blood bank
      ...
      //   id: "0x1D8068E8EcA9AA9219B2f6ee6776B7ae6a362b6c",
      //   email: "bb2@gmail.com",
      //   pass: "1234",
      //   type: "1", // Blood bank
    ...
    for (var i = 0; i < d.length; i++) {
      if (d[i]["id"] === accounts[0]) {
        try {
          ...
          console.log("Created successfully" , ad);
        } catch (err) {
...
//           .addidentity(
//             "ANKUR MULTISPECIALITY HOSPITAL",
//             '0x09f1Eb0efFcb8ee8E64d3e6Bb46427Efc67D6371',
//             'hsp1@gmail.com',
//             '1234',
//             "0", //hospital
//             "RB2 Central Railway Quarters, Jain Society, Sion, Mumbai",
...
//bloodbank
      ...
      //    "0x8D1881017dbbd502eCf251C07F368C2F6b716E04",
      //          "bb2@gmail.com",
      //        "1234",
      //        "1",
      //    "Piramal Nagar, Goregaon West, Mumbai, Maharashtra 400104",
      //    "+91 8446417448",
      //      "19.159587,72.845633"
      //     )
      //     .send({ from: accounts[0] });
    ...
    if (email_in.trim() !== "" && pass_in.trim() !== "") {
      ...
      try {
          ...
          const account_data = await contract.methods.getLogin(  accounts[0],        email_in.toString(),       pass_in.toString(), ).call();
   ...
   console.log(account_data);
     ...
     console.log("hi", account_data[1]);
     
          
          if (account_data[1] == 1) {  console.log("ko");
           setErrortext(""); history.push("/bloodbankhome"); }
          else setErrortext("Please Login as Hospital");
        } else {
          if (account_data[1] == 0)
          {
            setErrortext(""); history.push("/hospitalhome");
        }
          else setErrortext("Please Login as Blood Bank");
        }
      } catch (err) {
        console.log("Error in creation", err);
      }
              ...
              <Card className="card-login card-plain">
                <Form action="" className="form" method="">
                  ...
                  <CardFooter className="text-center">
                    ...
                    {errortext.length ? <p>{errortext}</p> : <p></p>}
